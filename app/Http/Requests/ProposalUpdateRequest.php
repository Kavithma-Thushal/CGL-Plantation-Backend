...
class ProposalUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name_with_initial_si' => 'required_if:lang,' . Languages::SINHALA . '|string|max:255',
            'family_name_si' => 'required_if:lang,' . Languages::SINHALA . '|string|max:255',
            'first_name_si' => 'required_if:lang,' . Languages::SINHALA . '|string|max:255',
            'middle_name_si' => 'required_if:lang,' . Languages::SINHALA . '|string|max:255',
            'last_name_si' => 'required_if:lang,' . Languages::SINHALA . '|string|max:255',
            'address_si' => 'required_if:lang,' . Languages::SINHALA . '|string|max:255',
            'nominees' => 'required|array',
            'plan_id' => 'required|exists:plans,id',
            'land_size' => 'nullable|numeric|min:0',
            'land_value' => 'nullable|numeric|min:0',
            'number_of_trees' => 'nullable|numeric',
            'term' => 'nullable',
            ...
            'beneficiary.first_name' => 'nullable|string|max:255|regex:/^[a-zA-Z\s]+$/',
            ...
            'beneficiary.nic' => 'nullable|string|max:30',
            'beneficiary.relationship' => 'nullable|string|max:255',
            ...
            'introducer.relationship' => 'nullable|string|max:255',
    ...
    {
        return UserPackage::find($this->id) != null;
    }
