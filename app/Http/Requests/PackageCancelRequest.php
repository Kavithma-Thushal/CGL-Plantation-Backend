...
class PackageCancelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_reference'=>'nullable|max:225'
        ];
    }
    ...
    private function packageCurrentStatusIsCorrect(): bool
    {
        ...
        return !in_array($packageTimeline->packageStatus->name,[PackageStatusesEnum::MATURED,PackageStatusesEnum::CANCELLED]);
    }
}
