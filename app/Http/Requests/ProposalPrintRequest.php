...
class ProposalPrintRequest extends FormRequest
{
    ...
    private function packageCurrentStatusIsCorrect(): bool
    {
        ...
        return in_array($packageTimeline->packageStatus->name,[PackageStatusesEnum::DOCUMENT_VERIFIED,PackageStatusesEnum::AGREEMENT_PRINT]);
    }
}
